...
public static class FileHandler
{
    ...
    /// <summary>
    /// Gets a dummy reference file
    /// </summary>
    /// <returns>OK</returns>
    public static async Task<IResult> GetDummyReferenceFile()
    {
        await File.WriteAllTextAsync("referenceFile.csv", DummyReferenceFile);
        return Results.Ok();
    }
}