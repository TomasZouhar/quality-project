...
{
    public StringBuilder FormatHoldingsTable(List<Holding> subtractedHoldings)
    {
    ...
    public StringBuilder FormatReducedHoldingsTable(List<Holding> subtractedHoldings)
    {
        var result = new StringBuilder();
